        ...
        <div class="container-fluid">
            <?php if (empty($this->raspberries)) { ?>
                <div class="alert alert-warning" role="alert">
                    <i class="mdi mdi-alert-outline mr-2"></i> <strong>Warning</strong> - You haven't added any raspberries yet!
                </div>
            <?php } ?>
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button type="button" class="btn btn-xs btn-blue waves-effect waves-light raspberryAction">
                                                ...
                                                <?php foreach ($this->raspberries as $key) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center text-nowrap" width="10%">
                                                            <button type="button" class="btn btn-xs btn-blue waves-effect waves-light raspberryAction" rId="<?= $key['id'] ?>">
                ...
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url() . $this->url; ?>changeUserInfo" method="post">
                                <div class="mb-3">
                                ...
                                <div class="text-center d-grid">
                                    <button class="btn btn-blue w-100" type="submit"> Change </button>
                                </div>
                            </form>
                        </div>
                    </div> <!-- end card-->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Raspberries</h4>
    ...
    $(window).ready(function() {
        ...
        $('.deleteRaspberry').click(function() {
            if (confirm('Are you sure ?')) {
                window.location.replace(`<?= base_url() . $this->url; ?>deleteRasbperry/${$(this).attr('rId')}`);
            }
        })
        $('.raspberryAction').click(function() {
            ...
            raspberyAjax = $.get(`<?= base_url() . $this->url; ?>getRaspberryInfo/${$(this).attr('rId') || 0}`)
                .done(function(data) {
