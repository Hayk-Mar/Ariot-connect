...
class Logs extends HM_Controller
{
    ...
    private function getLogs($raspUUID = 0, $dateRange = [])
    {
        ...
        $logs = $this->Main_model->get_query(
            'select flow, temperature, count, isOpen, createdAt from raspberry_records where createdAt BETWEEN "' . $dateRange[0] . ' 00:00:00" and "' . $dateRange[1] . ' 23:59:59" and raspberry_uuid = "' . $raspUUID . '" ORDER BY createdAt DESC'
        );
